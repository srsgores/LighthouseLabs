...
Size of the screen used to see the content. vw/vh/vmin/vmax are based on screen size, and not the parent
...
For specific elements, like a menu or a slider, it's cleaner to put it in a partial since you can reuse it easily on other projects
### Sass example : mixins
Mostly used for compatibility purposes, use prefixes instead of repeating them all the time. Also allows you to pass params/variables.
### Sass example : extend
